<?php
  ...
  function showInvoiceRow($seq_no, $row) {
    ...
    <tr>
      ...
      <td>
        <button class="btn btn-warning btn-sm d-none " onclick="printInvoice(<?php echo $row['INVOICE_ID']; ?>);">
          <i class="fa fa-fax"></i>
        </button>
  ...
  function printInvoice($invoice_number) {
    ...
    if($con) {
      $invoice_number = $_GET["invoice_number"];
      $query = "SELECT * FROM invoices INNER JOIN customers ON WHERE INVOICE_ID =  $invoice_number";
      $result = mysqli_query($con, $query);
    ...
    <div class="row">
      ...
      <div class="col-md-10 h3" style="color:#41c02c;">Customer Invoice<span class="float-right">Invoice Number : <?php echo $invoice_number; ?></span></div>
    </div>
    ...
    <div class="row text-center">
      <hr class="col-md-10" style="padding: 0px; border-top: 2px solid  #41c02c;">
    </div>
    <div class="row">
      <div class="col-md-1"></div>
      <div class="col-md-4">
